...
export type AdminApplicationStatus = 'APPLIED' | 'APPROVED' | 'REJECTED' | 'CANCELLED';
...
export type ParticipantAffiliationFilter = 'ALL' | AdminApplicationAffiliationType;

export const ADMIN_APPLICATION_STATUS_LABELS: Record<AdminApplicationStatus, string> = {
  APPLIED: '승인 대기',
  APPROVED: '승인',
  REJECTED: '반려',
  CANCELLED: '참가 취소',
...
export const ADMIN_APPLICATION_AFFILIATION_LABELS: Record<AdminApplicationAffiliationType, string> =
  {
    UNDERGRADUATE: '학부생',
    GRADUATE: '대학원생',
    PROFESSOR: '교수',
...
export const ADMIN_APPLICATION_STATUS_OPTIONS = (
  Object.entries(ADMIN_APPLICATION_STATUS_LABELS) as [AdminApplicationStatus, string][]
